...
public class FopServlet extends HttpServlet {
    ...
    private static final long serialVersionUID = 20201103113905L;
    ...
    protected static final String XSLT_REQUEST_PARAM = "template";
    ...
    public void init() throws ServletException {
        // This is needed to use the standard Transformer that comes with JDK 1.8+
        ...
        try {
            ...
            if ((xmlParam != null) && (xsltParam != null)) {
                ...
                out.println("<html><head><title>Error</title></head>\n"
                          + "<body><h1>FopServlet Error</h1><h3>No 'xml' and 'template' "
    ...
    /**
     * Renders an XML file into a PDF file by applying a stylesheet that converts
     * the XML to XSL-FO. The PDF is written to a byte array that is returned as the
     * method's result.
     *
     ...
     * transformer given to optionally transform the input document to XSL-FO. The
     * transformer may be an identity transformer in which case the input must
     * already be XSL-FO. The PDF is written to a byte array that is returned as the
     * method's result.
     *
